# Generated by Django 5.1.2 on 2024-12-09 11:46
...
class Migration(migrations.Migration):
    ...
    replaces = [('pets', '0001_initial'), ('pets', '0002_medicalreport_doctor_name'), ('pets', '0003_remove_petstatus_id_alter_petstatus_pet'), ('pets', '0004_alter_medicalreport_date_added_and_more'), ('pets', '0005_alter_pet_name'), ('pets', '0006_remove_pet_doctors'), ('pets', '0007_alter_pet_species')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('species', models.CharField(choices=[('dog', 'Dog'), ('cat', 'Cat'), ('rabbit', 'Rabbit'), ('rodent', 'Rodent'), ('bird', 'Bird'), ('reptile', 'Reptile'), ('other', 'Other')], default='other', max_length=50, verbose_name='species')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pet', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='status', serialize=False, to='pets.pet', verbose_name='pet')),
            ],
        ),
        migrations.CreateModel(
            name='MedicalReport',
