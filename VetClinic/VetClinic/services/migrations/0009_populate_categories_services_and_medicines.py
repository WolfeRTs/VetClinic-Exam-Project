...
def populate_categories_services_and_medicines(apps, schema_editor):
    Category = apps.get_model('categories', 'ServiceCategory')
    Service = apps.get_model('categories', 'Service')
    Medicine = apps.get_model('categories', 'Medicine')
    ...
    for category, category_en in categories.items():
        Category.objects.get_or_create(name=category, name_bg=category, name_en=category_en)
        category_saved, _ = Category.objects.get_or_create(
            name=category,
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('services', '0001_initial_squashed_0008_alter_medicine_name_alter_service_name_and_more'),
    ]

    operations = [
        migrations.RunPython(populate_categories_services_and_medicines)
    ]
